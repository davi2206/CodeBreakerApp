...
namespace Android.Support.V7.Internal.Widget {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='android.support.v7.internal.widget']/class[@name='FitWindowsFrameLayout']"
	[global::Android.Runtime.Register ("android/support/v7/internal/widget/FitWindowsFrameLayout", DoNotGenerateAcw=true)]
	public partial class FitWindowsFrameLayout : global::Android.Widget.FrameLayout, global::Android.Support.V7.Internal.Widget.IFitWindowsViewGroup {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("android/support/v7/internal/widget/FitWindowsFrameLayout", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (FitWindowsFrameLayout); }
		}

		protected FitWindowsFrameLayout (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Landroid_util_AttributeSet_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='android.support.v7.internal.widget']/class[@name='FitWindowsFrameLayout']/constructor[@name='FitWindowsFrameLayout' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.util.AttributeSet']]"
		[Register (".ctor", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "")]
		public unsafe FitWindowsFrameLayout (global::Android.Content.Context p0, global::Android.Util.IAttributeSet p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (FitWindowsFrameLayout)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='android.support.v7.internal.widget']/class[@name='FitWindowsFrameLayout']/constructor[@name='FitWindowsFrameLayout' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register (".ctor", "(Landroid/content/Context;)V", "")]
		public unsafe FitWindowsFrameLayout (global::Android.Content.Context p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Android.Support.V7.Internal.Widget.FitWindowsFrameLayout __this = global::Java.Lang.Object.GetObject<global::Android.Support.V7.Internal.Widget.FitWindowsFrameLayout> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='android.support.v7.internal.widget']/class[@name='FitWindowsFrameLayout']/method[@name='setOnFitSystemWindowsListener' and count(parameter)=1 and parameter[1][@type='android.support.v7.internal.widget.FitWindowsViewGroup.OnFitSystemWindowsListener']]"
